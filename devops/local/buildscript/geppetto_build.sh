...
DESKTOPCODE='../../../application/client/desktop/elevan_4891'
DESKTOPIMAGENAME='geppettotest/elevan_4891-desktop:1.0'
...
helm install --name elevan_4891 ./helm
if [ $? -eq 0 ]; then
